<x-app-layout>
    ...
    @if(session('success'))
    <div id="notification"
        class="z-50 relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        ...
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p class="text-sm leading-6 text-gray-900">
                <strong class="font-semibold">Neohubble informa</strong><svg viewBox="0 0 2 2"
    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="relative mt-2.5">
                        ...
                        <input type="tel" name="phone-number" id="phone-number" :value="old('phone-number')"
                            autocomplete="tel"
                ...
                <div>
                    ...
                    <div class="mt-2.5">
                        <input type="text" name="company-name" id="company-name" :value="old('company-name')"
                ...
                <div class="sm:col-span-2">
                    <label for="company-description"
                        class="block text-sm font-semibold leading-6 text-gray-900">Descrição sobre a empresa</label>
                    <div class="mt-2.5">
                        <textarea name="company-description" id="company-description"
                            :value="old('company-description')" rows="4"
                ...
                <div>
                    ...
                    <div class="mt-2.5">
                        <input type="text" name="strategy-quest1" id="strategy-quest1" :value="old('strategy-quest1)"
                            autocomplete="strategy-quest1"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div>
                    ...
                    <div class="mt-2.5">
                        <input type="text" name="strategy-quest2" id="strategy-quest2" :value="old('strategy-quest2)"
                            autocomplete="strategy-quest2"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div>
                    ...
                    <div class="mt-2.5">
                        <input type="text" name="strategy-quest3" id="strategy-quest3" :value="old('strategy-quest3)"
                            autocomplete="strategy-quest3"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2.5">
                        <textarea name="strategy-quest5" id="strategy-quest5" :value="old('strategy-quest5)" rows="4"
                            placeholder="Descreva sendo objetivo e claro."
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
        ...
        <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
            aria-hidden="true">
            <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%+rem)] sm:w-[115.1875rem]"
                style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)">
            </div>
        </div>
    </div>
