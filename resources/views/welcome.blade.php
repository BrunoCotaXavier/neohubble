        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 p-5 rounded-lg" style="background-color: rgba(255, 255, 255, 0.5); backdrop-filter: blur(10px);">
          <dl class="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">SEO</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Site seguro</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Responsivo</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Google Tools</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Suporte</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Personalização</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Tecnologia Avançada</dd>
            ...
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl" style="color: #474747;">Portal de Notícia</dd>
