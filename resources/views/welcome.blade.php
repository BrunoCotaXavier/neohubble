<x-app-layout>
  ...
  <div class="z-50 fixed bottom-0 w-full flex justify-end p-8 balance">
  ...
  <div class="bg-white">
    <div class="relative isolate px-6 lg:px-8">
        ...
        <div class="mx-auto py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-start">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="/#ComoCriarSite" class="text-sm font-semibold leading-6 text-gray-900">Saiba mais <span aria-hidden="true">→</span></a>
            </div>
          </div>
        </div>
        <div class="mx-auto py-32 sm:py-48 lg:py-56 pl-5">
          <img src="{{ asset('images/criar-site.svg') }}" class="hidden sm:block mx-auto" width="550" alt="Logo Neohubble" />
        </div>
      </div>
      <div>
        <div id="servicos" class="text-center py-42" style="padding-top: 200px;">
      ...
      <div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 p-5 rounded-lg" style="background-color: rgba(255, 255, 255, 0.5); backdrop-filter: blur(10px);">
          <dl class="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">SEO</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Site otimizado para buscas.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Site seguro</dd>
              <dt class="text-base leading-7 certificado-verde">Certificado SSL incluso.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Responsivo</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Responsivo em todos aparelhos.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Google Tools</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Integração ao Google Analytics.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Suporte</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Gratis 1 mes de suporte.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Personalização</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Personalização unica feita sobmedida. </dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Tecnologia Avançada</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Utilizamos as melhores tecnologias.</dt>
            </div>
            <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              <div style="display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="#5814dd" viewBox="0 0 256 256">
              ...
              <dd class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Portal de Notícia</dd>
              <dt class="text-base leading-7 text-gray-600 certificado-verde">Todos os dias uma nova noticia/ dica.</dt>
            </div>
          </dl>
        </div>
      </div>
  ...
  <div id="ComoCriarSite" class="bg-white">
    <div class="relative isolate px-6 lg:px-8 py-52">
      <div class="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">

        <div style="left: -1500px;" class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
          <div class="relative left-[calc(50%+3rem)] aspect-[1155/478] w-[36.125rem] rotate-[50deg] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-50 sm:left-[calc(50%+16rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)">
          </div>
        </div>
          ...
          <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div class="lg:pr-4">
              <div class="lg:max-w-lg">
                <h2 class="mt-2 text-4xl font-bold tracking-tight text-gray-900">Como <span style="color: #5815DD;">criar</span> meu site?</h2>
                <br />
                <div>
                ...
                <div>
                  ...
                  <p class="text-lg leading-8 text-gray-600">
                    Após analisar os dados e assinar o contrato, estamos prontos para começar o processo de desenvolvimento. Trabalhamos com <strong class="font-semibold text-gray-900">metodologia ágil</strong>, garantindo que você acompanhe cada etapa (Step) do desenvolvimento em tempo real.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                <ul role="list" class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span><strong class="font-semibold text-gray-900">Step Front-end</strong> No front-end, nós cuidamos de como o site é visualizado e usado pelos visitantes. Trabalhamos na parte que você vê e interage quando acessa um site, incluindo o layout, design, botões e navegação.</span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#5814dd" viewBox="0 0 256 256">
                    ...
                    <span><strong class="font-semibold text-gray-900">Step Back-end</strong>
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span><strong class="font-semibold text-gray-900">Step Deploy</strong> Fazer o deploy de um site é como colocar uma obra de arte em exibição. Você cria o seu trabalho (o site), e então o coloca em um lugar onde as pessoas possam vê-lo (na internet). Assim, quando alguém quiser ver sua obra, basta acessar o local (meusite.com) onde você a colocou. É como abrir uma galeria para que todos possam apreciar o que você criou, só que online!</span>
                  </li>
                </ul>
                ...
                <h3 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">Depois como <span style="color: #5815DD;">utilizar</span> meu site?</h3>
